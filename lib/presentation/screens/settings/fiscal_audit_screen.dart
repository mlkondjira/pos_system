      ...
      child: Column(
        children: [
          ...
          if (_lastCheck != null) ...[
            const SizedBox(height: 12),
            Text(
              'Dernier contrôle : ${Fmt.dateTime(_lastCheck!)}',
    ...
    return StreamBuilder<List<AuditLogWithActor>>(
      ...
      builder: (context, snapshot) {
        ...
        final logs = snapshot.data!
            .take(10)
            .toList(); // On ne montre que les 10 derniers

        if (logs.isEmpty) {
          return const Card(
            child: Padding(
              padding: EdgeInsets.all(20),
              child: Text('Aucune action critique enregistrée.'),
            ),
          );
        }
              ...
              .map(
                (log) => Card(
                  ...
                  child: ListTile(
                    ...
                    title: Text(
                      _translateAction(log.log.action),
                      style: const TextStyle(
                    ...
                    subtitle: Text(
                      'Par ${log.actorName} • ${Fmt.time(log.log.timestamp)}',
  ...
  String _translateAction(String action) {
    switch (action) {
      ...
      case 'user_deactivated':
        return 'Désactivation d\'un compte';
      case 'product_price_changed':
        return 'Changement de prix';
      case 'inventory_adjusted':
        return 'Ajustement manuel de stock';
      default:
        return action;
    }
  }
